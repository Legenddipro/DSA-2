...
public:
    ...
    double max_load;
    double load_factor_double_hash;
    Hash_table()
    {
    ...
    Hash_table(ll_int table_size, ll_int hash_type, string res_type, ll_int max_load)
...
ll_int Hash_table::doubleHash_find(string key)
{
    ...
    // doubleHash_find_pair.push_back(0);
    // doubleHash_find_pair.push_back(count_probe);
    pair<ll_int, ll_int> p(-1, count_probe);
...
ll_int Hash_table::doubleHash_insert(string key, ll_int value)
{
   ...
   // random_collection.push_back(key);
    ...
    present_size++;
    load_factor_double_hash = present_size/table_size;
    return collision;
}
else if(flag == 2)
{
